...
inputDir    = "/remote/nas00-1/users/charris/phd/fcc/FCCAnalyses/tutorial/localsamples"
...
url_model_dir = "https://fccsw.web.cern.ch/fccsw/testsamples/jet_flavour_tagging/winter2023/wc_pt_13_01_2022/" # noqa
url_preproc = "{}/{}.json".format(url_model_dir, model_name) # noqa
url_model = "{}/{}.onnx".format(url_model_dir, model_name) # noqa

## model files locally stored on /eos
model_dir = (
    "/eos/experiment/fcc/ee/jet_flavour_tagging/winter2023/wc_pt_13_01_2022/" #noqa
)
local_preproc = "{}/{}.json".format(model_dir, model_name) #noqa
local_model = "{}/{}.onnx".format(model_dir, model_name) #noqa
